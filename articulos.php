        ...
        <div id="banner-wrapper">
            <div id="banner" class="box container">
                ...
                <div id="crear" class="tabcontent">
                    ...
                    <tr>
                        <form method="post">
                            <th>Titulo: <input type="text" name="titulo" placeholder="Introduza titulo del artículo"
                                    pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+" required><br></th>
                            <th>Articulo: <textarea name="articulo" placeholder="Introduza su artículo" rows="10"
                                    cols="40" pattern="[a-zA-ZñÑáéíóúÁÉÍÓÚ ]+" required></textarea><br></th>
